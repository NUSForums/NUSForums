...
module.exports = {
  purge: {
    ...
    options: {
      safelist: [
        ...
        'bg-forum-lecture',
        'bg-forum-sidebar',
        'bg-forum-sidebarHover',
        'bg-forum-searchbar',
        'bg-forum-background',
        'bg-forum-text',
        'bg-forum-title',
        'bg-forum-sidebarTitle',
        'bg-forum-createPost',
        'bg-forum-readMore',
        'bg-forum-sidebarText',
        'bg-forum-postCard',
        'bg-forum-subText',
        'bg-forum-grayText',
        'text-forum-general',
        ...
        'text-forum-lecture',
        'text-forum-sidebar',
        'text-forum-sidebarHover',
        'text-forum-searchbar',
        'text-forum-background',
        'text-forum-text',
        'text-forum-title',
        'text-forum-sidebarTitle',
        'text-forum-createPost',
        'text-forum-readMore',
        'text-forum-sidebarText',
        'text-forum-postCard',
        'text-forum-subText',
        'text-forum-grayText',
        'flex',
  ...
  theme: {
    ...
    boxShadow: {
      ...
      none: 'none',
      blue1: '0 9px 10px -1px rgba(255, 201, 28, 0.25), 0 4px 6px 1px rgba(255, 201, 28, 0.15)',
    ...
    fontSize: {
      ...
      primary: ['2.35rem', { lineHeight: '2.35rem' }],
    ...
    gridTemplateColumns: {
      ...
      'auto-10': 'repeat(auto-fill, minmax(10rem, 1fr))',
